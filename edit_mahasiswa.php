...
<body>
	...
	<form method="POST" action="">
		...
		<table>
			...
			<tr>
				<td>Alamat &nbsp;</td>
				<td><input type="text" name="alamat" class="input" value="<?= $row['alamat']; ?>"></td>
			</tr>
...
<?php  
	...
	if (isset($_POST['submit'])) {
		...
		$query = "UPDATE mahasiswa SET nama='$nama', fakultas='$fakultas', prodi='$prodi', agama='$agama', nomorhp='$nomorhp', alamat='$alamat' WHERE nim=$nimUpdate";
